...
from internportal.models import Applicant
...
class Command(BaseCommand):
    help = 'Export applicant data from admin to Excel'

    def handle(self, *args, **options):
        update_excel_sheet()
        self.stdout.write(self.style.SUCCESS('Applicant data exported successfully.'))
